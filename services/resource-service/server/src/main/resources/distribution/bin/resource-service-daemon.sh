...
SERVICE_NAME="MFT Resource Service"
...
case $1 in
    start)
        ...
        if [ ! -f $PID_PATH_NAME ]; then
            ...
            org.apache.airavata.mft.resource.server.ResourceServiceApplication ${AIRAVATA_COMMAND}
            echo $! > $PID_PATH_NAME
    ...
    ;;
    -h)
        echo "Usage: resource-service-daemon.sh"
